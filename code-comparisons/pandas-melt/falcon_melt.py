...
def df_generator(n: int = 10, max_cols: int = 1_000, max_rows: int = 100_000):
...
def valid_dataframe(outcome) -> bool:
...
def sums_correctly(outcome) -> bool:
...
def is_melted_id_value(outcome) -> bool:
    key, df = outcome
